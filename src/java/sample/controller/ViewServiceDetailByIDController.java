 ...
 */
public class ViewServiceDetailByIDController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SERVICE_DETAIL_PAGE = "servicedetailemp.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ServiceDTO service = dao.getServiceByID(serviceID);
