            ...
            <main>
                ...
                <div class="table-data">
                    <div class="order">
                        ...
                        <c:if test="${LIST_APPOINMENT_BY_DATE != null}">
                            <table>
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                <tbody>
                                    <c:forEach var="listAppoinmentByDate" items="${LIST_APPOINMENT_BY_DATE}" varStatus="loop">
                                    <form action="MainController" method="POST">
                                        <tr>
                                        <input type="hidden" value="${DOCTORID}" name="doctorID"/>
                                        <input type="hidden" value="${listAppoinmentByDate.appoinmentID}" name="appoinmentID"/>
                                        <td>${loop.count}</td>
                                        <td>
                                            <p>${listAppoinmentByDate.fullName}</p>
                                        </td>
                                        <td>${listAppoinmentByDate.appointment_date}</td>
                                        <td><span>${listAppoinmentByDate.email}</span></td>
                                        <td><span>${listAppoinmentByDate.phoneNumber}</span></td>
                                        <td><span>${listAppoinmentByDate.note}</span></td>
                                        <td><span class="status pending">${listAppoinmentByDate.status}</span></td>
