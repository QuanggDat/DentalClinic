            ...
            <main>
                ...
                <div class="table-data">
                    <div class="order">
                        ...
                        <c:if test="${LIST_COMMENT_BY_TIME_DOCTOR != null}">
                            <table>
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                <tbody>
                                    <c:forEach var="listCommentByTimeDoctor" items="${LIST_COMMENT_BY_TIME_DOCTOR}" varStatus="loop">
                                        <tr>
                                            <td>${loop.count}</td>
                                            <td>
                                                <p style="font-weight: 600; color: #002060;">${listCommentByTimeDoctor.name}</p>
                                            </td>
                                            <td>${listCommentByTimeDoctor.cmtTime}</td>
                                            <td><span style="font-weight: 500; color: #2eb7e5;">${listCommentByTimeDoctor.contentCmt}</span></td>
                                            <td><span class="status pending" style="color: white;">${listCommentByTimeDoctor.rate}</span></td>
                                            <td><span class="status pending">${listCommentByTimeDoctor.status}</span></td>
                                        </tr>
                                    </c:forEach>                                                                   
                                </tbody>
                            </table>
